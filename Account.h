...
protected:
	...
	*/
	void add_interest(double interest) {
		...
		Transaction *tran = new Transaction(customer->getCustID(),customer->getAcctType(), balance, fees);
...
public:
	...
	*/
	Account() //default constructor for inheritance
	{};
	...
	*/
	...
	/// I do not see the need for this to be a virtual function
	std::string to_string() {
		...
		ss << "  Age: " << customer->getAge() << std::endl;
		ss << "  Type of Customer: " << customer->getCustType() << std::endl;
		ss << "  Account Type:" << customer->getAcctType() << std::endl;
